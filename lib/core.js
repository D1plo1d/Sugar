...
(function() {
  ...
  extend(array, true, false, {
     ...
     * @method alphabetize()
     * @returns Array
     * @short Alphabetizes the array.
     * @extra Uses the each object's toString() method to sort the array in alphabetical order.
     * @example
     *   ["A", "e", "C", "d", "b"].alphabetize()   -> ["A", "b", "C", "d", "e"]
     *
     ***/
     'alphabetize': function() {
       var arr = this.clone();
       arr.sort(function(a, b) {
         return a.toString().toLowerCase().compare( b.toString().toLowerCase() );
       });
       return arr;
     },
